...
function GENERATOR_listCase(data) {
    ...
    let rst = "<a href=\"https://duawieh.github.io/content?" + data.index + "\"><div class=\"ListpageShowcase\"><img class=\"ListpageShowcaseCover\" src=\"";
    rst += ((data.cover != "null") ? NONE_COVER : data.cover) + "\" alt=\"图片加载错误\"/><div class=\"ListpageShowcaseTextcase\"><p class=\"ListpageShowcaseTitle\">";
