// $("#homepageCenterShowcaseTitle_Title").load("./contents/homepageShowcase/showcase1/title.txt");
// $("#homepageLeftShowcaseTitle_Title").load("./contents/homepageShowcase/showcase2/title.txt");
// $("#homepageRightShowcaseTitle_Title").load("./contents/homepageShowcase/showcase3/title.txt");

// $("#homepageCenterShowcaseTitle_Subtitle").load("./contents/homepageShowcase/showcase1/subtitle.txt");
// $("#homepageLeftShowcaseTitle_Subtitle").load("./contents/homepageShowcase/showcase2/subtitle.txt");
// $("#homepageRightShowcaseTitle_Subtitle").load("./contents/homepageShowcase/showcase3/subtitle.txt");
